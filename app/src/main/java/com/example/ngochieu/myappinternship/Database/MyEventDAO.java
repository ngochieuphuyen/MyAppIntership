...
public class MyEventDAO {
    ...
    public MyEventDAO(Context context, DatabaseHandler databaseHandler) {
    ...
    public MyEvent getEvent(int id){
        ...
        MyDateDAO myDateDAO = new MyDateDAO(context,databaseHandler);
    ...
    public List<MyEvent> getAllEvent(){
        ...
        SQLiteDatabase db = databaseHandler.getWritableDatabase();
        String sql =" select * form "+DatabaseHandler.TABLE_EVENTS;
    ...
    public List<MyEvent> getListEventDate(int idOfDate){
        List<MyEvent> listEvent = new ArrayList<>();
        SQLiteDatabase db = databaseHandler.getWritableDatabase();
        String sql =" select * form "+DatabaseHandler.TABLE_EVENTS + "where "+ DatabaseHandler.EventColumn._ID + " = " + idOfDate;
