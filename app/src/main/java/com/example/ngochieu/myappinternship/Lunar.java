...
/**
 * Created by NgocHieu on 1/11/2017.
 */
...
//lunarLeap = 1;
        ...
        String lunarDayStr = String.valueOf(lunarDay);
        String lunarMonthStr = String.valueOf(lunarMonth);
        String lunarYearStr = String.valueOf(lunarYear);
